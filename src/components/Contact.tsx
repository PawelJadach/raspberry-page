	...
	return (
		<div className="px-2 py-20 md:p-32 bg-[#F4F4F4]">
			...
			<div className="flex flex-col justify-center items-center mt-12 gap-8">
				<motion.p whileHover="hover" custom={0} variants={item} initial="hidden" viewport={{ once: true }} whileInView="visible" className="flex gap-4">
				...
				<motion.p whileHover="hover" custom={1} variants={item} initial="hidden" viewport={{ once: true }} whileInView="visible" className="flex gap-4">
				...
				<motion.p whileHover="hover" custom={2} variants={item} initial="hidden" viewport={{ once: true }} whileInView="visible" className="flex gap-4">
					<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
